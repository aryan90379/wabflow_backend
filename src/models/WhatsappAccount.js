...
const whatsappAccountSchema = new mongoose.Schema(
  {
    ...
    officialDisplayNameRequested: { type: String, default: "" },
    officialDisplayNameRequestStatus: {
      type: String,
      enum: ["none", "pending", "approved"],
      default: "none",
    },
    officialDisplayNameRequestedAt: { type: Date, default: null },
    officialDisplayNameApprovedAt: { type: Date, default: null },
    officialDisplayNameLastSyncedAt: { type: Date, default: null },
    officialDisplayNameChangeCount: { type: Number, default: 0 },
    officialDisplayNameChangeWindowStart: { type: Date, default: null },
    ...
    profileWebsites: { type: [String], default: [] },
    profileVertical: { type: String, default: "" },
  profilePictureUpdateStatus: { type: String, enum: ["none", "success", "failed"], default: "none" },
  profilePictureChangeCount: { type: Number, default: 0 },
  profilePictureLastUpdatedAt: { type: Date },
