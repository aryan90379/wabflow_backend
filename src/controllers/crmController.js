...
export async function updateBooking(req, res) {
  const allowed = ["serviceItemId", "type", "status", "startDate", "endDate", "startTime", "endTime", "guests", "customerName", "customerPhone", "notes", "cardTheme", "metadata"];
  const update = Object.fromEntries(Object.entries(req.body).filter(([key]) => allowed.includes(key)));
...
export async function createBooking(req, res) {
  const allowed = ["serviceItemId", "contactId", "conversationId", "type", "status", "startDate", "endDate", "startTime", "endTime", "guests", "customerName", "customerPhone", "notes", "cardTheme", "metadata"];
