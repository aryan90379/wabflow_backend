...
export async function createBusiness(req, res) {
  const business = await Business.create({
    ...
    customerCareMobile: req.body.customerCareMobile || "",
    customerCareLandline: req.body.customerCareLandline || "",
    customerCareEmail: req.body.customerCareEmail || "",
    grievanceOfficerName: req.body.grievanceOfficerName || "",
    grievanceOfficerMobile: req.body.grievanceOfficerMobile || "",
    grievanceOfficerLandline: req.body.grievanceOfficerLandline || "",
    grievanceOfficerEmail: req.body.grievanceOfficerEmail || "",
